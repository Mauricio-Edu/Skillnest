...
print(cantidad_de_dias_o_meses_o_semanas_en_anio() + cantidad_de_glaciares_argentina())""" #función no definida
#3
...
#print(suma(10, 5) + suma(4, 3))     se genera error de tipo al usar operador +
#7
def concatenar(a, b):
    return str(b) + str(a)
